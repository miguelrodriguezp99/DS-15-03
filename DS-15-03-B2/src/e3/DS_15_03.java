...
public class DS_15_03 implements Behavior {

    int i = 0;
    //Metodo behavior, dependiendo de la accion del rival o de la situacion actual del pistolero, realizará una acción u otra
    //#######################################################################################################################
    //Para que funcione correctamente en cada partida tienen que limpiarse las listas de los movimientos de los gunslinger
    //Asi se reinicia tambien el contador de turnos
    @Override
    public GunslingerAction action(Gunslinger g) {
        if(g.getRivalActions().size() == 0) i = 0;
